...
![CloudFront・Lambda・SQS・Auroraを組み合わせたインフラ構成図](https://static.zenn.studio/user-upload/63cc524f6afe-20260513.png)
...
準備が整ったのでいよいよ実装に入ります。ツールは今回 **k6** を採用しました（社内推奨や知見蓄積という観点からほぼ即決で採用したため、ツール比較についてはこの記事には書きません！）。
...
![Datadogダッシュボードの例](https://static.zenn.studio/user-upload/6d21fbe1f9e8-20260512.png)
...
![1000-users DB計測結果](https://static.zenn.studio/user-upload/38c6dfe9efdf-20260513.png)
...
![1000-users API Lambda計測結果](https://static.zenn.studio/user-upload/6f5f1ead290e-20260513.png)
...
![1000-users Worker Lambda計測結果](https://static.zenn.studio/user-upload/7318c75a3ded-20260513.png)
...
![5000-users DB計測結果](https://static.zenn.studio/user-upload/c72c4453123a-20260513.png)
...
![5000-users API Lambda計測結果](https://static.zenn.studio/user-upload/eb0d360ea056-20260513.png)
...
![5000-users Worker Lambda計測結果](https://static.zenn.studio/user-upload/ef36227cc7a8-20260513.png)
...
![10000-users DB計測結果](https://static.zenn.studio/user-upload/83bf39a44610-20260513.png)
...
![10000-users API Lambda計測結果](https://static.zenn.studio/user-upload/4cb2a3b0cf44-20260513.png)
...
![10000-users Worker Lambda計測結果](https://static.zenn.studio/user-upload/6594ab658984-20260513.png)
...
![10000-users再実行 DB計測結果](https://static.zenn.studio/user-upload/cf7515ab2a73-20260513.png)
...
![10000-users再実行 API Lambda計測結果](https://static.zenn.studio/user-upload/13e2ff7d89b4-20260513.png)
...
![10000-users再実行 Worker Lambda計測結果](https://static.zenn.studio/user-upload/34d08dfc88bc-20260513.png)
